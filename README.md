...
## Overview
By leveraging existing camera infrastructure, MarketLens deploys lightweight agents on local IPCs (edge nodes) to process frames in milliseconds without internet dependency. Only metadata and critical alerts sync to the central cloud for fleet management.
